eagle.define('eagle_dashboard.eagle_dashboard', function (require) {
    ...
    var DashboardDragon = AbstractAction.extend(ControlPanelMixin, {
        ...
        ksRenderDashboard: function () {
            ...
            var $eagle_header = $(QWeb.render('DashboardDragonHeader', {
...
//            ".eagle_date_input_fields"
    ...
    core.action_registry.add('eagle_dashboard', DashboardDragon);

    return DashboardDragon;
});